...
class GroundHumiditySensor():
   ...
   def __init__(self):
      ...
      # Set up logging       
      self.logger = logging.getLogger('GroundHumiditySensor')
   ...
   def getGroundHumidity(self):
   
      delay = 1.0
      self.spi.open(0,0)
      val = self.readChannel(0)
      self.logger.debug('Current GroudHumidity: '+ str(140*(1023-val)/1023))
      if (val != 0):
         return 140*(1023-val)/1023
